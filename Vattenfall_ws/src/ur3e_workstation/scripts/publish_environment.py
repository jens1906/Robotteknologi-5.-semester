...
class EnvironmentPublisher(Node):
    ...
    def publish_environment(self):
        ...
        # We do NOT publish collision objects for the table, mount, or test plate here
        # because they are already defined in the URDF (workstation.xacro).
        # Publishing them again as collision objects causes duplication (red + green).
        
        # If you have dynamic objects that are NOT in the URDF, add them here.
        # For now, we leave the list empty to avoid duplication.
